...
public class Verifier implements CoinSlotListener, SelectionButtonListener, DeliveryChuteListener, CoinRackListener, CoinReceptacleListener,
    ...
    @Override
    public void popCanAdded(PopCanRack popRack, PopCan pop) {
    }

    @Override
    public void popCanRemoved(PopCanRack popRack, PopCan pop) {
    }

    @Override
    public void popCansFull(PopCanRack popRack) {
    }

    @Override
    public void popCansEmpty(PopCanRack popRack) {
    }
    ...
    @Override
    public void coinsUnloaded(CoinRack rack, Coin... result) {
	switch(state) {
	case WAIT:
	    state = State.UNLOAD;
    ...
    @Override
    public void popCansUnloaded(PopCanRack popRack, PopCan... cans) {
	switch(state) {
	case WAIT:
	    state = State.UNLOAD;
    ...
    @Override
    public void popCansLoaded(PopCanRack popRack, PopCan... cans) {
	switch(state) {
	case WAIT:
	    state = State.LOAD;
	    pops[getIndex(popRack)] = true;
