...
public class ChangingConfigurationVendingMachineFactoryTest {
	...
	vm.configure(new ProductKind("A", new Cents(5)), new ProductKind("B", new Cents(10)), new ProductKind("C", new Cents(25)));
	...
	vm.configure(new ProductKind("Coke", new Cents(250)), new ProductKind("water", new Cents(250)), new ProductKind("stuff", new Cents(205)));
    }
