...
public final class CoinReceptacle extends AbstractHardware<CoinReceptacleListener> implements AbstractCoinAcceptor {
    ...
    private HashMap<Cents, CoinChannel> coinRacks = new HashMap<Cents, CoinChannel>();
     ...
     */
    public void connect(Map<Cents, CoinChannel> rackChannels, CoinChannel coinReturn, CoinChannel other) {
	...
	for(Coin coin : coinsEntered) {
	    CoinChannel ccs = coinRacks.get(coin.getValue());
