package org.lsmr.vending.frontend2.hardware;
...
public final class PopCanRack extends AbstractHardware<PopCanRackListener> implements AbstractPopCanAcceptor {
     ...
     * rack, a "popCanAdded" event is announced to its listeners. If, as a
     * result of adding this pop can, this pop can rack has become full, a
     * "popCansFull" event is announced to its listeners.
     * 
     * @param popCan
     ...
     * @deprecated Will be removed in Assignment 3. Use acceptPopCan instead.
     */
    @Deprecated
    public void addPopCan(PopCan popCan) throws CapacityExceededException, DisabledException {
	if(isDisabled())
     ...
     * is removed from this pop can rack, a "popCanRemoved" event is announced
     * to its listeners. If the removal of the pop can causes this pop can rack
     * to become empty, a "popCansEmpty" event is announced to its listeners.
     * 
     * @throws DisabledException
