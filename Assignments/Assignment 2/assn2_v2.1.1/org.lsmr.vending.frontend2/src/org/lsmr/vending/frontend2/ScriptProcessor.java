...
import org.lsmr.vending.frontend2.parser.Parser;
...
public class ScriptProcessor {
     ...
     *             If hardware that is disabled is required to accept coins or
     *             pop cans.
     */
    public ScriptProcessor(String path, IVendingMachineFactory factory, boolean debug) throws IOException, ParseException, DisabledException {
